...
test_gen_predict <- generator_test(
    data,
    lookback = lookback,
    delay = delay,
    min_index = 701,
...
y_hat <- predict_generator(model,test_gen_predict,steps = test_steps)
y <- data[(701+lookback+1):nrow(data),'total_cases']

plot(y,y_hat)
abline(a = 0,b = 1,col='red')

plot(y,type='l',main='Comparison of y and yhat on test-data')
lines(y_hat,col='red',pch=2)
